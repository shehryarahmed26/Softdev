...
const Services = () => {
  ...
  return (
    <div>
      ...
      <Link to={'/contactus'}><button className='text-xs hover:bg-blue-950 hover:text-white md:text-base px-3  md:px-6 rounded-lg border-blue-600 border-2 py-1 font-bold'>Get Free Consultation</button></Link>
        </div>
