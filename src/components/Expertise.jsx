    ...
    <div>
        ...
        <div className="services flex flex-col justify-center items-center">
            <div className="service md:border flex flex-col md:flex-row w-full py-3 px-5 md:px-10 justify-between  items-center">
                ...
                <p className='text-sm md:text-base my-4 md:my-0 text-gray-500'>SoftDev specializes in creating responsive, high-performance websites using modern technologies like React and Next.js. We deliver dynamic, scalable solutions.</p>
            </div>
            <div className="service flex flex-col md:flex-row md:border w-full py-3 px-5 md:px-10 justify-between  items-center">
                ...
                <p className='text-sm md:text-base my-4 md:my-0 text-gray-500'>SoftDev specializes in creating custom web applications that are scalable, secure, and tailored to meet specific business needs, delivering a seamless user experience.</p>
            </div>
            <div className="service flex flex-col md:flex-row md:border w-full  py-3 px-5 md:px-10 justify-between  items-center">
                ...
                <p className='text-sm md:text-base my-4 md:my-0 text-gray-500'>SoftDev provides robust eCommerce solutions, ensuring secure transactions, user-friendly interfaces, and features that drive conversions and optimize business operations.</p>
            </div>
            <div className="service flex flex-col md:flex-row md:border w-full  py-3 px-5 md:px-10 justify-between  items-center">
                ...
                <p className='text-sm md:text-base my-4 md:my-0 text-gray-500'>SoftDev develops software management systems that streamline processes, enhance productivity, and provide real-time data insights for better decision-making and efficiency.</p>
            </div>
        </div>
    </div>
  )
