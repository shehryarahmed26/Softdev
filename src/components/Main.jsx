...
const Main = () => {
  return (
    <div className='flex flex-col md:flex-row justify-center items-center px-2 w-full'>
        <div className="left">
        <h2 className='text-3xl my-8 md:my-0 md:text-7xl md:min-w-[530px] text-center text-gray-800'>We Create <span className='main-span font-bold'>Meaningful</span> Experiences</h2>
        </div>
        <div className="right flex flex-col gap-2 md:gap-5 md:border bottom-2 px-4">
            ...
            <h3 className='text-3xl md:text-5xl'><span className='main-span'>Ecommerce</span> Development</h3>
            ...
            <h3 className='text-3xl md:text-5xl'><span className='main-span'>Custom Web</span> Development</h3>
            <p>Artificial Intelligence has become as essential part of every IT service in today’s world. In this dire situation, Aciano technologies provide unmatched AI development services. Our AI professionals specialize in developing custom AI solutions to meet your specific business requirements. Our services include:</p>
