...
const Counter = () => {
  return (
    <div className='counter-sec flex flex-wrap items-center px-4 md:px-20 justify-between'>
        <div className='flex w-[120px] md:w-fit flex-col gap-3 items-center justify-center text-center'>
        ...
        <div className='flex flex-col w-[120px] md:w-fit gap-3 items-center justify-center text-center'>
